...
- ✅ Asociaciones con Sequelize correctamente realizadas.
- ✅ handleChange en AddEditProduct corregido.
- ✅ Campos no usados eliminados(description, category).
- ✅ Middleware de autenticación en el backend creado.
- ✅ Consultas N+1 en logs optimizadas.
- ✅ Validaciones en el backend agregadas.
- ✅ Nombres de propiedades estandarizados(full_name vs fullName).

### Pendientes

- ⚠️ Agregar expiración a tokens JWT
- ⚠️ Extraer componentes duplicados
- ⚠️ Mejorar manejo de errores global
